...
const Checkout = () => {
  ...
  return (
    <div className="checkout-container">
      <h2
        className='text-3xl font-bold m-4 ml-5 text-blue-950 text-center'
      >
        Checkout
      </h2>
      <div className="checkout-content">
        <form onSubmit={handleSubmit} className="shipping-form">
          ...
          <div className="checkout-summary">
            ...
            <button
              type="submit"
              className="cursor-pointer btn bg-amber-700 rounded-md px-2 py-1 text-white transition transform duration-200 hover:bg-orange-500 hover:scale-110 hover:shadow-[0_0_25px_rgba(249,115,22,0.35)]"
            >
              Pay Now
            </button>
          </div>
