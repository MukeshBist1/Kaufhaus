    ...
    <div className="product-detail-wrapper" style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px' }}>
      ...
      <div className="product-detail">
        ...
        <div className="detail-info">
          ...
          <h2 className='text-white' style={{ fontSize: '2.8rem', marginBottom: '10px' }}>{product.name}</h2>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
            <button onClick={handleAddToCart} className="btn bg-amber-300" style={{ flexGrow: '1', padding: '18px', fontSize: '1.2rem' ,color: '#fff'}}>
